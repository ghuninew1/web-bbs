...
const Studio = () => {
    ...
    return (
        <Layout title="Studio">
            <Container
                fluid="lg"
                className="studio g-0 d-flex justify-content-center"
            >
                {!titles && (
                    <Anim
                    ...
                    >
                        <h1 className="studio-active">
                            ...
                            CHANGED{' '}
                            <span style={{ fontSize: '35px', padding: '10px' }}>
                                THE{' '}
                            </span>
                            NAME!!
                        </h1>
                    ...
                    <Container>
                        <Row>
                            <Col className="mx-3">
                                ...
                                >
                                    ...
                                    <p className="studio-text">
                                        ...
                                        <span>Auchara Kijkanjanas</span>, one of
                                        the pioneers in the Computer Graphic
                                        Industry in Thailand. For 20 years of
                                        experience, her expertise and works were
                                        guaranteed by both International and
                                        Domestic awards for Animation Feature
                                        Film and VFX work.
                                    </p>
                                    <p className="studio-text mb-3">
                                        At <span>Big Brain Studio</span>, We
                                        selectively assemble a team of creative,
                                        innovative and professional staff
                                        enabling us to initiate content design
                                        to meet quality demand and industry
                                        directions.
                                    </p>
                                    <h2>Our Team :</h2>
                                    <p className="studio-text">
                            ...
                            <Col md="4" className="studio-img">
                                <Anim
                                    type={
                                        !titles ? 'fadeOutDown' : 'slideInRight'
                                    }
                                    duration={800}
                                    delay={400}
                                >
                                    <Image
                                        src={'/img/sutudio/ptum.webp'}
                                        fluid
                                    />
                                </Anim>
                            </Col>
